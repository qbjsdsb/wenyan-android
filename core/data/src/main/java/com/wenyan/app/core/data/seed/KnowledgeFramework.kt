...
object KnowledgeFramework {
    ...
    val nodes: List<FrameworkNode> = listOf(
        ...
        FrameworkNode("modern_second_styles", "modern_second", "京派、海派与地域书写", 2),
        ...
        FrameworkNode("modern_third_war", "modern_third", "战争、历史与人性书写", 1),
    ...
    private val assignmentPairs: List<Pair<String, String>> = buildList {
        ...
        addAll(mapPoints("modern_history_late_qing", 582..586, listOf(946, 954)))

        addAll(mapPoints("modern_first_movements", 587..593, 602..604, listOf(939, 953)))
        addAll(mapPoints("modern_first_poetry", 594..601))
        addAll(mapPoints("modern_first_prose", listOf(605, 606, 609)))
        addAll(mapPoints("modern_first_publication", listOf(607, 608)))
        addAll(mapPoints("modern_first_lu", 610..621))

        addAll(mapPoints("modern_second_styles", 622..626, listOf(915, 916, 945)))
        addAll(mapPoints("modern_second_fiction", 627..633, listOf(917)))
        addAll(mapPoints("modern_second_left", 634..636, listOf(941)))
        addAll(mapPoints("modern_third_war", listOf(919, 940, 947)))

        addAll(mapPoints("modern_seventeen_system", listOf(637)))
        addAll(mapPoints("modern_seventeen_red", 638..640, 648..656, listOf(948, 949, 950)))
        addAll(mapPoints("modern_seventeen_rural", 641..647))
        ...
        addAll(mapPoints("modern_since_realism", listOf(910, 706, 707, 711)))
        addAll(mapPoints("modern_since_history", listOf(686, 687, 688, 690, 708, 709, 716, 719, 720, 920)))
        ...
        addAll(mapPoints("modern_since_poetry", listOf(722, 724, 725, 726, 921, 922)))
