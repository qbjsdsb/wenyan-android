 ...
 *
 * 这份配置覆盖中国古代文学的 465 个知识点。节点 ID 是稳定的数据标识，发布
...
object AncientKnowledgeFramework {
    ...
    private val assignmentPairs: List<Pair<String, String>> = buildList {
        ...
        addAll(mapPoints("ancient_pre_qin_thinkers", 13..13, 99..100, 162..166, 224..224))
        ...
        addAll(mapPoints("ancient_sui_tang_middle_late", 38..41, 113..115))
        ...
        addAll(mapPoints("ancient_song_southern", 47..47, 49..50, 125..125, 128..128, 304..310))
        addAll(mapPoints("ancient_song_fiction", 51..51))
        addAll(mapPoints("ancient_liao_jin", 52..52, 130..130, 311..311))
        ...
        addAll(mapPoints("ancient_yuan_poetry", 355..363))
        ...
        addAll(mapPoints("ancient_qing_fiction", 75..76, 79..81, 83..83, 404..417, 427..427, 914..914))

        addAll(mapPoints("ancient_near_modern_overview", 84..84, 136..136, 431..431))
        addAll(mapPoints("ancient_near_modern_gong", 432..434))
        addAll(mapPoints("ancient_near_modern_poetry_prose", 137..138, 435..438, 444..454))
        addAll(mapPoints("ancient_near_modern_fiction", 439..441, 455..459))
