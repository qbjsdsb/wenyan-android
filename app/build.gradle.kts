...
android {
    ...
    defaultConfig {
        ...
        // v0.9.45=70（全应用审计加固：练习/写作导航与持久化加固（PR #18）+ UI 布局标准化（PR #19）+ 全面审计修复（PR #20）。）
        // v0.9.46=71（第二次全仓库审计加固（PR #21）+ 后续审计边界修复（PR #22）。）
        versionCode = 71
        ...
        // v0.9.45：全应用审计加固（见 versionCode 注释）
        // v0.9.46：第二次全仓库审计加固与后续边界修复（见 versionCode 注释）
        versionName = "0.9.46"
